    ...
    <div className="text-4xl">
      <div className="w-screen h-640 bg-cover bg-no-repeat bg-center bg-[url('../../assets/images/email-footer-bg.svg')] flex items-center justify-center">
        <div className="text-light flex flex-col items-center justify-center w-full">
          ...
          By selecting 'SIGN UP,' I confirm that I am at least eighteen (18) years old. I have read, comprehended, and consent to abide by the Terms of Service and Privacy Policy. Additionally, I agree to receive emails and customer service communications from Houseplant through email. I retain the option to unsubscribe at any time by clicking 'unsubscribe' in the emails.
          </p>
        </div>
      </div>
      <div className="flex">
