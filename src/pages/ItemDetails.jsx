      ...
      <div className="flex flex-col justify-center items-center lg:items-start lg:pr-24 px-4 lg:px-0">
        ...
        <div className="flex flex-col xl:flex-row items-center justify-start max-w-4xl text-sm pb-20">
          <p className="uppercase text-xs xl:text-sm text-center lg:text-left">
            for interest-free payments of{" "}
            <span>{(Math.round((price / 4) * 100) / 100).toFixed(2)} Rs </span>{" "}
            with
          </p>
          <img
            src={badge}
        ...
        One per customer restriction applies. Generally ships within 3-5 business days. This promotion cannot be combined with other discounts or coupons and cannot be applied retroactively. The item is not eligible for return.
        </p>
      </div>
    </section>
  );
